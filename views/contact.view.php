        ...
        <div class="row">
           <div class="editor position-relative">
            ...
            <form class="ActiveForm" style="padding:20px" class="col-sm-7" novalidate method="post" action="#">
                ...
                <input type="hidden" name="csrfmiddlewaretoken" value="sPxajxiPG07VPF2gpvANBLemacU7zE0KSubTDMxZGPyXTbZoV9Lz9XGd7SZKy3tZ">
                <div class="row cont-row">
                    <div  class="col-sm-3"><label>Enter Name </label><span>:</span></div>
                    <div class="form-group col-sm-8">
                        <input type="text" name="name" aria-required="true" class="form-control  input-sm input-round" placeholder="Full name" aria-label="name" required id="id_name">
                ...
                <div  class="row cont-row">
                    ...
                    <div class="form-group col-sm-8">
                        <input type="email" name="email" aria-required="true" class="form-control  input-sm input-round" placeholder="Email address" aria-label="email" required id="id_email">
                        <div class="feedback" style="margin-top:-22px"></div>
                    </div>
                </div>
                <div  class="row cont-row">
                ...
                <div  class="row cont-row">
                    ...
                    <div class="form-group col-sm-8">
                        <input type="text" name="subject" aria-required="true" class="form-control  input-sm input-round" placeholder="subject " aria-label="subject" required id="id_subject">
                        <div class="feedback" style="margin-top:-22px"></div>
                    </div>
                </div>
                <div  class="row cont-row">
                    ...
                    <div class="form-group col-sm-8">
                        <textarea name="message" cols="40" rows="5" aria-required="true" class="form-control  input-sm" placeholder="Message" aria-label="message" required id="id_message">
</textarea>
                        <div class="feedback" style="margin-top:-22px"></div>
                    </div>
                </div> 
                <div style="margin-top:10px;" class="row">
                    <div class="col-12 text-center">
                        <button class="btn btn-primary btn-sm btn-round">Send Message</button>
                    </div>
                </div>
            </form>
           </div>
            <div class="col-md-4 col-sm-12 map-img">
                ...
                <address class="md-margin-bottom-40">
                   Rilum Foundation<br>
                   Shillong,India <br>
                    Phone: <a href="tel:+910000000000">+910000000000</a><br>
                    Email: <a href="mailto:illuminate@gmail.com" class="">Rilum@gmail.com</a><br>
                    Web: <a href="/" class="">https://Rilumfoundation.org/</a>
                </address>
            </div>
        </div>
    </div>
